@extends('template.ui')
@section('title', 'Detail peminjam umum')
@section('breadcrumb')
         ...
         <div class="invoice p-3 mb-3">
            ...
            <div class="row no-print">
               <div class="col-12">
                  ...
                  <a href="{{ route('admin.print.umum', $peminjam->id) }}" target="_blank" class="btn btn-default"><i class="fas fa-print"></i> Print</a>
                  ...
                  {{-- <a href="{{ route('admin.generatePdf.umum', $peminjam->id) }}" class="btn btn-primary btn-flat float-right" style="margin-right: 5px;">
   ...
   $('#pengembalian').on('click', function(e){
      ...
      Swal.fire({
         ...
         if (result.value) {
            $.ajax({
               type: "GET",
               url: "/administator/umum/pengembalian/"+id,
               data: {
                  "id": id,
                  "_token": "{{ csrf_token() }}"
               },
