...
<ol class="breadcrumb float-sm-right">
   ...
   <li class="breadcrumb-item active"><a href="{{ route('admin.pegawai.index') }}">Data peminjam</a></li>
      ...
      <div class="col-12">
         <div class="invoice p-3 mb-3">
            ...
            <div class="row no-print">
               ...
               <a href="{{ route('admin.print.mahasiswa', $peminjam->id) }}" target="_blank" class="btn btn-default"><i class="fas fa-print"></i> Print</a>
               ...
               {{-- <a href="{{ route('admin.generatePdf.mahasiswa', $peminjam->id) }}" class="btn btn-primary btn-flat float-right" style="margin-right: 5px;">
   ...
   $('#pengembalian').on('click', function(e){
      ...
      Swal.fire({
         ...
         if (result.value) {
            $.ajax({
               type: "GET",
               url: "/administator/peminjaman/pengembalian/"+id,
               data: {
                  "id": id,
                  "_token": "{{ csrf_token() }}"
               },
