@extends('template.ui')
@section('titel', 'Peminjaman auditorium')
@section('breadcrumb')
<ol class="breadcrumb float-sm-right">
   <li class="breadcrumb-item active">Data auditorium</li>
</ol>
@endsection
                        ...
                        <td>
                           ...
                           @else
                              <div class="btn-group-vertical">
                                 <a class="btn btn-primary btn-flat" href="{{ route('admin.auditorium.peminjamanMahasiswa', $value->room_id) }}">Mahasiswa</a>
                                 <a class="btn btn-primary btn-flat" href="{{ route('admin.auditorium.peminjamanPegawai', $value->room_id) }}">Pegawai</a>
                                 <a class="btn btn-primary btn-flat" href="{{ route('admin.auditorium.peminjamanUmum', $value->room_id) }}">Umum</a>
                              </div>
                           @endif
                        </td>
                     </tr>
